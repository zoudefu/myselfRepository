...
public class HttpLogin {
	 public static void main(String[] args) {
	        // 登陆 Url
	        String loginUrl = "http://172.18.104.152:8080/jobreading-wechat-web/wechat/login";
	        // 需登陆后访问的 Url
	        String dataUrl = "http://172.18.104.152:8080/jobreading-wechat-web/router.html#bookCity";
